...
public class AirSensorHourVo {
	...
	public String toString() {
		return "AirSensorHourVo [data_date=" + data_date + ", data_hour=" + data_hour + ", group_id=" + group_id
				+ ", sensor_id=" + sensor_id + ", sensor_lat=" + sensor_lat + ", sensor_lon=" + sensor_lon
				+ ", temp_avrg=" + temp_avrg + ", humid_avrg=" + humid_avrg + ", pm25_grm_avrg=" + pm25_grm_avrg
				+ ", pm10_grm_avrg=" + pm10_grm_avrg + "]";
	}
